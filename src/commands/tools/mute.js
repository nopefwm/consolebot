const { Client, SlashCommandBuilder, PermissionFlagsBits, EmbedBuilder, PermissionsBitField } = require("discord.js");
const ms = require('ms');
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            console.log(`${user.username} has been timed out for ${convertedTime}`)
